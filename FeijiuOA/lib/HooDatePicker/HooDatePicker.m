...
// Constants sizes :
static CGFloat const kHooDatePickerHeight = 210.0f;
...
- (void)actionButtonValid:(UIButton *)sender {
    ...
    if ([self.delegate respondsToSelector:@selector(datePicker:didSelectedDate:WithFlag:)]) {
        [self.delegate datePicker:self didSelectedDate:[self getDate]WithFlag:_flag];
    }
}
